...
- both the web interface and the terminal will show `Listening...`
- You can now speak into the mic
- Once you stop speaking, it will show `Stopped listening`
- It will start processing the request
- Once the response is ready, it will show `Speaking...`
- response will be played and displayed in the web interface.
